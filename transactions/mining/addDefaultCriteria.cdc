...
transaction() {
    ...
    prepare(signer: AuthAccount) {
        ...
        let tx = BloctoTokenMining.Criteria(reward: 1.0, divisor: 1, capTimes: 5)
        let referral = BloctoTokenMining.Criteria(reward: 5.0, divisor: 1, capTimes: 6)
        let assetInCirculation = BloctoTokenMining.Criteria(reward: 1.0, divisor: 100, capTimes: 10)
