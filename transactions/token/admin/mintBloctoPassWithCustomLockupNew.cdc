...
transaction(address: Address, amount: UFix64, startDate: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        let lockupSchedule = {
            0.0                       : 1.0,
            startDate                 : 1.0,
            startDate + 12.0 * months : 12.0 / 24.0,
            startDate + 13.0 * months : 11.0 / 24.0,
            startDate + 14.0 * months : 10.0 / 24.0,
            startDate + 15.0 * months : 9.0 / 24.0,
            startDate + 16.0 * months : 8.0 / 24.0,
            startDate + 17.0 * months : 7.0 / 24.0,
            startDate + 18.0 * months : 6.0 / 24.0,
            startDate + 19.0 * months : 5.0 / 24.0,
            startDate + 20.0 * months : 4.0 / 24.0,
            startDate + 21.0 * months : 3.0 / 24.0,
            startDate + 22.0 * months : 2.0 / 24.0,
            startDate + 23.0 * months : 1.0 / 24.0,
            startDate + 24.0 * months : 0.0
        }
